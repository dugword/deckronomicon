...
type ActionNode interface {
	Resolve(ctx *evalstate.EvalState) (action.Action, error)
}

type PassAction struct{}

func (p *PassAction) Resolve(ctx *evalstate.EvalState) (action.Action, error) {
	return action.Action{
		Type: action.ActionPass,
	}, nil
}

type ConcedeAction struct{}

func (c *ConcedeAction) Resolve(ctx *evalstate.EvalState) (action.Action, error) {
	return action.Action{
		Type: action.ActionConcede,
	}, nil
}
...
func (a *ActivateAction) Resolve(ctx *evalstate.EvalState) (action.Action, error) {
...
func (p *PlayAction) Resolve(ctx *evalstate.EvalState) (action.Action, error) {
	/*
		var available []GameObject
