...
func NewAbility(source Object, idx int, abilityDefinition *definition.Ability) (*Ability, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to parse cost %q: %w", abilityDefinition.Cost, err)
	}
