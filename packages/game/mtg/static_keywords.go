...
var AllStaticKeywords = map[StaticKeyword]StaticKeyword{
...
func IsStaticKeyword(s StaticKeyword) bool {
	_, ok := AllStaticKeywords[s]
	return ok
}

func ParseStaticKeyword(s StaticKeyword) (StaticKeyword, bool) {
