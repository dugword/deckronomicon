...
func (p *StrategyParser) parseActionNode(raw any) action.ActionNode {
	...
	case map[string]any:
		...
		return &action.PassAction{} // No action specified, default to pass
	default:
...
func (p *StrategyParser) parsePlayAction(value any) action.ActionNode {
	...
	case string:
		return &action.PlayAction{CardNames: []string{val}}
	case []any:
		var cards []string
		...
		return &action.PlayAction{CardNames: cards}
	case map[string]any:
		...
		return &action.PlayAction{CardNames: []string{cardName}}
	default:
...
func (p *StrategyParser) parsePassAction(value any) action.ActionNode {
	...
	return &action.PassAction{}
}

func (p *StrategyParser) parseActivateAction(raw any) action.ActionNode {
	switch val := raw.(type) {
	case string:
		return &action.ActivateAction{AbilityNames: []string{val}}
	case []any:
		...
		return &action.ActivateAction{AbilityNames: abilities}
	case map[string]any:
		...
		return &action.ActivateAction{AbilityNames: []string{ability}}
	default:
