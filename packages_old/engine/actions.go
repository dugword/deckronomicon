...
func (e *Engine) ResolveAction(act game.Action, player *player.Player) (result ActionResult, err error) {
	switch act.Type {
...
func ActionAddManaFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
...
// This is a cheat.
func ActionConjureFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
...
func ActionDiscardFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
...
func ActionDrawFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
	count := target.Name
	n := 1
	var err error
	if count != "" {
...
// This is a cheat.
func ActionFindFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
...
// This is a cheat.
func ActionLandDropFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
...
func ActionUntapFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
...
func ActionViewFunc(state *GameState, player *player.Player, target game.ActionTarget) (ActionResult, error) {
	/*
		var choice Choice
