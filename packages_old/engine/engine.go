...
func (e *Engine) PreparePlayers() error {
...
func (e *Engine) RunGameLoop() error {
	if err := e.PreparePlayers(); err != nil {
...
func (e *Engine) RunPriority(player *player.Player) error {
	for {
		if err := e.ResolvePlayerAction(player); err != nil {
			return err
		}
...
func (e *Engine) ResolvePlayerAction(player *player.Player) error {
	...
	for {
		...
		if !game.PlayerActions[act.Type] {
